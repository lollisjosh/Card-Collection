    ...
    try:
        ...
        if cards is not None:
            ...
            for card in cards:
                ...
                # Process subtypes
                if hasattr(card, 'subtypes') and card.subtypes is not None:
                    if len(card.subtypes) > 0:
                        subtype_1 = card.subtypes[0]
                    if len(card.subtypes) > 1:
                        subtype_2 = card.subtypes[1]
                ...
                card_list.append({
                    ...
                    "ability1Desc": ability_1_Text,
                    "ability1Type": ability_1_Type,
                    "ability2Name": ability_2_Name,
                    "ability2Desc": ability_2_Text,
            ...
            self.search_results.emit(json.dumps({"error": "Search failed or no results found."}))
